...
export class SecureModeModal extends Modal {
  ...
  private async encryptKeysWithPassword(password: string) {
    this._plugin.settings.apiKey = SecureModeCrypt.encryptString(
      this._plugin.settings.apiKey,
      password
    );
    this._plugin.settings.apiSecret = SecureModeCrypt.encryptString(
      this._plugin.settings.apiSecret,
      password
    );
    this._plugin.settings.accessToken = SecureModeCrypt.encryptString(
      this._plugin.settings.accessToken,
      password
    );
    this._plugin.settings.accessTokenSecret = SecureModeCrypt.encryptString(
  ...
  private async decryptKeysWithPassword(password: string) {
    this._plugin.settings.apiKey = SecureModeCrypt.decryptString(
      this._plugin.settings.apiKey,
      password
    );
    this._plugin.settings.apiSecret = SecureModeCrypt.decryptString(
      this._plugin.settings.apiSecret,
      password
    );
    this._plugin.settings.accessToken = SecureModeCrypt.decryptString(
      this._plugin.settings.accessToken,
      password
    );
    this._plugin.settings.accessTokenSecret = SecureModeCrypt.decryptString(
      this._plugin.settings.accessTokenSecret,
      password
    );
