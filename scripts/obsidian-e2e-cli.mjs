...
Examples:
  ...
  pnpm run obsidian:e2e -- --vault notetweet-my-worktree eval code='app.plugins.plugins.notetweet?.manifest?.version'
...
export async function ensureObsidianInstance(options) {
	...
	await trustVaultAndVerifyNoteTweet(options);
